...
# News
path_train_news_small = "/home/langenhagen/Masterthesis/Masterarbeit/Dataset_small/train/news.tsv"
path_train_news_large = "/home/langenhagen/Masterthesis/Masterarbeit/MINDlarge_train.zip/train/news.tsv"

path_val_news_small = "/home/langenhagen/Masterthesis/Masterarbeit/Dataset_small/valid/news.tsv"
path_val_news_large = "/home/langenhagen/Masterthesis/Masterarbeit/MINDlarge_train.zip/valid/news.tsv"

# Behaviors
path_train_behaviors_small = "/home/langenhagen/Masterthesis/Masterarbeit/Dataset_small/train/behaviors.tsv"
path_train_behaviors_large = "/home/langenhagen/Masterthesis/Masterarbeit/MINDlarge_train.zip/train/behaviors.tsv"

path_val_behaviors_small = "/home/langenhagen/Masterthesis/Masterarbeit/Dataset_small/valid/behaviors.tsv"
path_val_behaviors_large = "/home/langenhagen/Masterthesis/Masterarbeit/MINDlarge_train.zip/valid/behaviors.tsv"
...
def create_sentiments_in_news(news_data = "/home/langenhagen/Masterthesis/Masterarbeit/Dataset_small/train/news.tsv", save_csv = "/home/langenhagen/Masterthesis/Masterarbeit/Dataset_small/train/"):
    """Creates a new dataframe which yields another column 'Sentiment' which indicates the sentiment of the title

    Args:
        news_data (str, optional): Path to the news data which should be used. Defaults to train data "/home/langenhagen/Masterthesis/Masterarbeit/Dataset_small/train/news.tsv".
        save_csv (str, optional): Path to the save directory. If None the dataframe is not saved. Defaults to "/home/langenhagen/Masterthesis/Masterarbeit/Dataset_small/train/".
...
def hist_to_cat():
    ...
    df_hist_cats.to_csv("/home/langenhagen/Masterthesis/Masterarbeit/hist_to_cats.tsv",sep='\t')
...
def categories_count_to_dict():
    ...
    with tqdm(total=len(small_train_behaviors)) as pbar:
        for impr in small_train_behaviors['Impressions'].to_dict().values():
            ...
            pbar.update(1)
    if True:
        with open('category_count_shown.pkl', 'wb') as f:
            pickle.dump(category_count_shown, f)
        # with open('category_count_clicked.pkl', 'wb') as f:
...
def get_impression_and_behavior_sentiments():
    ...
    path_sentimented_news = "/home/langenhagen/Masterthesis/Masterarbeit/Dataset_small/train/test_with_sentiment.tsv"
