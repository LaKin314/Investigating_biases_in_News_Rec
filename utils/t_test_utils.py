...
def get_loaded_model_with_seed(model_type : str, weight_paths : list, seed = 42, batch_size = 32, epochs = 5):
    ...
    Args:
        ...
        weight_paths (list): Relative path to "Save_models/"
    ...
    if model_type == "NRMS":
        ...
        for path in weight_paths:
            ...
            model.model.load_weights(f"Save_models/{path}/")
...
def ttest_proto():
    ...
    nrms_1.model.load_weights("Save_models/NRMS_weights_hist_1/").expect_partial()
    nrms_10.model.load_weights("Save_models/NRMS_weights_hist_10/").expect_partial()
    nrms_25.model.load_weights("Save_models/NRMS_weights_hist_25/").expect_partial()
    nrms_50.model.load_weights("Save_models/NRMS_weights_hist_50/").expect_partial()
    nrms_100.model.load_weights("Save_models/NRMS_weights_hist_100/").expect_partial()
    nrms_150.model.load_weights("Save_models/NRMS_weights_hist_150/").expect_partial()
